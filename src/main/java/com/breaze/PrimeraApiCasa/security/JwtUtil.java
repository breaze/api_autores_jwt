...
// Importaciones de la librería JJWT para manejo de JWT
import io.jsonwebtoken.Claims;       // Representa el payload (cuerpo) del token
import io.jsonwebtoken.Jwts;         // Constructor y parser de tokens JWT
import io.jsonwebtoken.io.Decoders;  // Utilidad para decodificar la clave secreta en BASE64
import io.jsonwebtoken.security.Keys; // Genera la clave criptográfica HMAC

// Importaciones de Spring
import org.springframework.beans.factory.annotation.Value; // Inyecta valores desde application.properties
import org.springframework.security.core.GrantedAuthority;  // Representa un rol/permiso del usuario
import org.springframework.security.core.userdetails.UserDetails; // Interfaz con los datos del usuario autenticado
