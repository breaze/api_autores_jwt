 ...
 *
 * Extiende {@link OncePerRequestFilter} para garantizar que la lógica
 * de validación no se repita si la petición pasa por varios dispatchers.
 *
 * Flujo general:
 * <ol>
 *   <li>Lee el encabezado {@code Authorization}.</li>
 *   <li>Si no existe o no empieza con "Bearer ", deja pasar la petición sin autenticar.</li>
 *   <li>Extrae el token, valida su firma y vigencia, y carga el usuario de la BD.</li>
 *   <li>Si todo es correcto, registra la autenticación en el {@link SecurityContextHolder}.</li>
 * </ol>
 */
@Component
